...
{
  "children": [
    {"type": "key", "id": "key1", "props": {"keys": ["q"], "description": "Quit", "color": "#212"}},
    {"type": "key", "id": "key2", "props": {"keys": ["r"], "description": "Refresh", "color": "#212"}},
    {"type": "key", "id": "key3", "props": {"keys": ["h"], "description": "Help", "color": "#212"}}
  ]
}
```
