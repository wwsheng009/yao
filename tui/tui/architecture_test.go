...
func TestComponentConfigPropagation(t *testing.T) {
	...
	tableComp := component.NewTableComponent(config, "test_table")
	if tableComp == nil {
		t.Fatal("Failed to create table component with config")
	}

	// Test menu component
	menuComp := component.NewMenuComponent(config, "test_menu")
	if menuComp == nil {
		t.Fatal("Failed to create menu component with config")
	}

	// Test header component
	headerComp := component.NewHeaderComponent(config, "test_header")
	if headerComp == nil {
