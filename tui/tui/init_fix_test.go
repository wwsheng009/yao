...
func TestInputComponentInitReturnsFocusCmd(t *testing.T) {
	...
	wrapper := component.NewInputComponentWrapper(props, "test-input")
...
func TestFormComponentInitCollectsChildCmds(t *testing.T) {
	...
	wrapper := component.NewFormComponentWrapper(props, "test-form")
	
	// Register some input fields with enabled status
	input1 := component.NewInputComponentWrapper(component.InputProps{
		Placeholder: "Field 1",
		Disabled:    false, // Will return Focus Cmd
	}, "field1")
	input2 := component.NewInputComponentWrapper(component.InputProps{
		Placeholder: "Field 2", 
		Disabled:    false, // Will return Focus Cmd
	}, "field2")
